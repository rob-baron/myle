...
public:
    ...
    virtual void get_direction(char *dir, int n);  // This returns a name for the direction
    virtual void set_direction(const char *dir);   // This sets a name for the direction
    virtual void set_direction( int dir );         // This sets a number for the direction
    virtual int get_direction();                   // This returns the number for the direction
